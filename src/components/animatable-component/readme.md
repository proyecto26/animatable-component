...
| `animation`          | `animation`           | Name of the animation to get the keyFrames                                                                                                                                                                   | `ANIMATIONS.BOUNCE \| ANIMATIONS.FLASH \| ANIMATIONS.HEART_BEAT \| ANIMATIONS.JELLO \| ANIMATIONS.PULSE \| ANIMATIONS.ROTATE \| ANIMATIONS.RUBBER_BAND \| ANIMATIONS.SHAKE \| ANIMATIONS.SWING \| ANIMATIONS.TADA \| ANIMATIONS.WOBBLE` | `undefined` |
