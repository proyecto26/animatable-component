...
export const FADE_IN: Keyframe[] = [
  { offset: 0, opacity: 0 },
  { offset: 1, opacity: 1 },
];

export const FADE_IN_UP: Keyframe[] = [
  { offset: 0, opacity: 0, transform: 'translateY(100%)' },
  { offset: 1, opacity: 1, transform: 'translateY(0)' }
];

export const FADE_IN_UP_BIG: Keyframe[] = [
  { offset: 0, opacity: 0, transform: 'translateY(2000px)' },
  { offset: 1, opacity: 1, transform: 'translateY(0px)' }
];

export const FADE_IN_DOWN: Keyframe[] = [
  { offset: 0, opacity: 0, transform: 'translateY(-100%)' },
  { offset: 1, opacity: 1, transform: 'translateY(0)' }
];

export const FADE_IN_DOWN_BIG: Keyframe[] = [
  { offset: 0, opacity: 0, transform: 'translateY(-2000px)' },
  { offset: 1, opacity: 1, transform: 'translateY(0px)' }
];

export const FADE_IN_RIGHT: Keyframe[] = [
  { offset: 0, opacity: 0, transform: 'translateX(100%)' },
  { offset: 1, opacity: 1, transform: 'translateX(0)' }
];

export const FADE_IN_RIGHT_BIG: Keyframe[] = [
  { offset: 0, opacity: 0, transform: 'translateX(2000px)' },
  { offset: 1, opacity: 1, transform: 'translateX(0px)' }
];

export const FADE_IN_LEFT: Keyframe[] = [
  { offset: 0, opacity: 0, transform: 'translateX(-100%)' },
  { offset: 1, opacity: 1, transform: 'translateX(0)' }
];

export const FADE_IN_LEFT_BIG: Keyframe[] = [
  { offset: 0, opacity: 0, transform: 'translateX(-2000px)' },
  { offset: 1, opacity: 1, transform: 'translateX(0px)' }
];
