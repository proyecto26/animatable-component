...
- Put a script tag similar to this `<script src='https://unpkg.com/animatable-component@0.0.7/dist/animatable-component.js'></script>` in the head of your index.html
